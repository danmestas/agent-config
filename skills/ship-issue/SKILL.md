...
- Post the agent brief as an issue comment. **Do not add AI attribution** — no "generated by AI" disclaimer, no co-author trailer, no robot emoji. Issue and PR content should read as if the operator authored it. This is a global rule (see `~/.claude/CLAUDE.md` *Never attribute Claude*) and applies to every artifact this skill creates, not just commits.
...
- **No AI attribution** — no co-author trailer, no "generated by" notice, no robot emoji. This is a global rule (`~/.claude/CLAUDE.md` *Never attribute Claude*) and applies to every artifact this skill creates: commits, PR bodies, issue comments, close comments — everything.
- HEREDOC the message:
