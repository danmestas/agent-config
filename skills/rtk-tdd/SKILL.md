...
targets: [claude-code]
type: skill
description: Use when implementing, testing, refactoring, or bug-fixing Rust code in the rtk CLI proxy — enforces Red-Green-Refactor with anyhow/thiserror error handling, `#[cfg(test)]` modules, and Arrange-Act-Assert structure
category:
  primary: workflow
license:
  upstream: Apache-2.0
