...
targets: [claude-code]
type: skill
description: Use when you want a shareable Markdown recap of the rtk repository state — open PRs (grouped into ours / external-reviewable / external-problematic), open issues with priorities, recent releases, executive summary, and a clipboard copy. Pass `en` or `fr` for language (defaults to French)
category:
  primary: workflow
license:
  upstream: Apache-2.0
  source: rtk-ai/rtk@3ba1634
  path: .claude/skills/repo-recap/SKILL.md
---
