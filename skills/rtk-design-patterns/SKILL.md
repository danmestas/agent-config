---
name: rtk-design-patterns
version: 1.0.0
targets: [claude-code]
type: skill
description: Use when designing a new rtk filter module or refactoring an existing one — picks between Newtype, Builder, State Machine, Trait Object, RAII, Strategy, and Extension Trait, with rtk-flavored guardrails against premature abstraction
category:
  primary: workflow
license:
  upstream: Apache-2.0
